...
public class AnimatorController {
    ...
    private void readAnimConfig() {
        dim = new Dimension(Integer.parseInt(view.getTextWidth()), Integer.parseInt(view.getTextHeight()));
    ...
    private void createObjectSet() throws Exception {
        ...
        switch (shapeType) {
            ...
            case Oval: objs.addOval(nShapes, dim, pathShapes); break;
            case Triangulo: objs.addTriangulo(nShapes, dim, pathShapes); break;
        }
    ...
    private void createAndShowAnimFrame() {
        ...
        AnimationPanel panel = new AnimationPanel(objs, dim, millis, view.getHorror().isSelected());
        animFrame.add(panel);
        animFrame.pack();
